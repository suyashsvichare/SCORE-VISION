...
#SET PAGE WIDE
st.set_page_config(page_title='IPL_SCOREVISION ',layout="centered")
...
st.markdown("<h1 style='text-align: center; color: white;'> IPL SCOREVISION </h1>", unsafe_allow_html=True)
